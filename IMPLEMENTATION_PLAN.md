...
| 2026-08-06 | Public access enabled on Railway Postgres (junction.proxy.rlwy.net, EU West); migrations applied to the live DB and verified (tables + view + pg_trgm + generated search_vector, counts 0/0/0).                                                                                                                                                           |
